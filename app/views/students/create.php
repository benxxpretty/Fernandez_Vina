    ...
    <section>
      <form action="<?=site_url('students/create');?>" method="POST" class="space-y-5" novalidate>
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 gap-5">
          <div>
            <label class="block text-sm font-semibold text-indigo-700 mb-1">First Name</label>
          ...
          <div>
            <label class="block text-sm font-semibold text-indigo-700 mb-1">Last Name</label>
        ...
        <div>
          <label class="block text-sm font-semibold text-indigo-700 mb-1">Gmail Address</label>
        ...
        <div class="flex justify-between items-center pt-4">
          ...
          <button type="submit"
            class="bg-indigo-700 text-white font-semibold px-6 py-3 rounded-xl shadow-lg hover:bg-indigo-800 hover:shadow-xl transition duration-200">
             Create
          </button>
        </div>
      </form>
